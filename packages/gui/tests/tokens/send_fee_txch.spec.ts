...
test('Verify that a recipient wallet receives funds from sending wallet!', async () => {
  //Pre-requisites
  let receiveWallet = 'tcac1km02nle6485x6fv676m7nx67zfyk75ed0znq3dwumj8wvxm2pvms9m0dnf';
  let sendWallet = 'tcac1ls7ur56shuh58zlvzkqkwgzch8zy6llfwr7ydm3n8rvky4rdf3dqlceyzx';
