...
test('Confirm that User cannot send a TCAC fee greater then in Wallet', async () => {
  let receive_wallet = 'tcac1u237ltq0pp4348ppwv6cge7fks87mn4wz3c0ywvgswvpwhkqqn8qn8jeq6';
  ...
  await page.locator('text=Fee *TCAC >> input[type="text"]').fill('10');
  ...
  await expect(page.locator('text=Pending Change0 TCAC')).toBeVisible();
});
