import { useOpenFullNodeConnectionMutation } from '@cactus-network.net/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@cactus-network.net/core';
