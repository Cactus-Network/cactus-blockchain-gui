import { useOpenFullNodeConnectionMutation } from '@cactus-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@cactus-network/core';
