import type { DataLayerOfferSummary, SingletonSummaryRecord } from '@cactus-network/api';
import { Color, CopyToClipboard, Flex, Truncate, truncateValue } from '@cactus-network/core';
