...
contextBridge.exposeInMainWorld(API.CACTUS_LOGS, {
  getContent: () => invokeWithCustomErrors(CactusLogsAPI.GET_CONTENT),
  getInfo: () => invokeWithCustomErrors(CactusLogsAPI.GET_INFO),
  setPath: () => invokeWithCustomErrors(CactusLogsAPI.SET_PATH),
});
