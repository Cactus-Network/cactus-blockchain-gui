...
export type ParamSchema = {
  ...
  humanize?: 'mojo-to-cac' | 'mojo-to-cat';
};
...
function getOffer(params: Record<string, unknown>, fileContents: boolean) {
  return sendCommand('get_offer', 'cactus_wallet', {
...
export const Commands: Record<string, CommandSchema> = {
  'cactus_app.show_notification': {
    ...
    dapp: [
      {
        command: 'cactus_showNotification',
  ...
  'cactus_app.request_permissions': {
    ...
    dapp: [
      {
        command: 'cactus_requestPermissions',
        title: () => i18n._(/* i18n */ { id: 'Request Permissions' }),
  ...
  'cactus_wallet.send_transaction': {
    ...
    dapp: [
      {
        command: 'cactus_sendTransaction',
  ...
  'cactus_wallet.nft_transfer_nft': {
    ...
    params: [
      ...
      { name: 'fee', label: () => i18n._(/* i18n */ { id: 'Fee' }), type: 'bigint', humanize: 'mojo-to-cac' },
    ],
    dapp: [
      {
        command: 'cactus_transferNFT',
  ...
  'cactus_wallet.create_offer_for_ids': {
    ...
    dapp: [
      {
        command: 'cactus_createOfferForIds',
  ...
  'cactus_wallet.sign_message_by_address': {
    ...
    dapp: [
      {
        command: 'cactus_signMessageByAddress',
  ...
  'cactus_wallet.sign_message_by_id': {
    ...
    dapp: [
      {
        command: 'cactus_signMessageById',
  ...
  'cactus_wallet.nft_set_nft_did': {
    ...
    dapp: [
      {
        command: 'cactus_setNFTDID',
        title: () => i18n._(/* i18n */ { id: 'Set NFT DID' }),
      },
    ],
  },

  // TODO verify param names in cactus-blockchain
  ...
  'cactus_wallet.create_new_wallet': {
    ...
    dapp: [
      ...
      {
        command: 'cactus_createNewDIDWallet',
        ...
        confirmLabel: () => i18n._(/* i18n */ { id: 'Create' }),
        params: [
          { name: 'amount', label: () => i18n._(/* i18n */ { id: 'Amount' }), type: 'bigint', humanize: 'mojo-to-cac' },
          { name: 'fee', label: () => i18n._(/* i18n */ { id: 'Fee' }), type: 'bigint', humanize: 'mojo-to-cac' },
      ...
      {
        command: 'cactus_createNewRemoteWallet',
  ...
  'cactus_harvester.add_plot_directory': {
  ...
  'cactus_harvester.remove_plot_directory': {
  ...
  'cactus_full_node.open_connection': {
  ...
  'cactus_full_node.close_connection': {
  ...
  'cactus_farmer.close_connection': {
    title: () => i18n._(/* i18n */ { id: 'Confirm Disconnect' }),
  ...
  'cactus_wallet.spend_clawback_coins': {
    ...
    dapp: [
      {
        command: 'cactus_spendClawbackCoins',
  ...
  'cactus_wallet.push_transactions': {
    ...
    dapp: [
      {
        command: 'cactus_pushTransactions',
  ...
  'cactus_wallet.nft_mint_bulk': {
    ...
    params: [
      ...
      {
        name: 'cac_coins',
        label: () => i18n._(/* i18n */ { id: 'CAC Coins' }),
        type: 'json',
        isOptional: true,
      },
      {
        name: 'cac_change_target',
        label: () => i18n._(/* i18n */ { id: 'CAC Change Target' }),
        type: 'string',
        isOptional: true,
      },
      {
  ...
  'cactus_wallet.did_update_metadata': {
    ...
    dapp: [
      {
        command: 'cactus_updateDIDMetadata',
        preserveNestedDataKeys: true,
  ...
  'cactus_data_layer.create_data_store': {
    ...
    dapp: [
      {
        command: 'cactus_createDataStore',
  ...
  'cactus_data_layer.remove_subscriptions': {
    ...
    dapp: [
      {
        command: 'cactus_removeSubscriptions',
  ...
  'cactus_data_layer.add_missing_files': {
    ...
    dapp: [
      {
        command: 'cactus_addMissingFiles',
  ...
  'cactus_data_layer.clear_pending_roots': {
    ...
    dapp: [
      {
        command: 'cactus_clearPendingRoots',
  ...
  'cactus_data_layer.make_offer': {
    ...
    dapp: [
      {
        command: 'cactus_makeDataLayerOffer',
  ...
  'cactus_data_layer.take_offer': {
    ...
    dapp: [
      {
        command: 'cactus_takeDataLayerOffer',
  ...
  'cactus_data_layer.cancel_offer': {
    ...
    dapp: [
      {
        command: 'cactus_cancelDataLayerOffer',
  ...
  'cactus_data_layer.verify_offer': {
    ...
    dapp: [
      {
        command: 'cactus_verifyOffer',
        title: () => i18n._(/* i18n */ { id: 'Verify Offer' }),
      },
    ],
  },

  'cactus_wallet.register_remote_coins': {
    ...
    dapp: [
      {
        command: 'cactus_registerRemoteCoins',
  ...
  'cactus_wallet.get_wallet_balance': {
    ...
    dapp: [
      {
        command: 'cactus_getWalletBalance',
        title: () => i18n._(/* i18n */ { id: 'Get Wallet Balance' }),
        message: () =>
          i18n._(
            /* i18n */ {
  ...
  'cactus_wallet.get_wallet_balances': {
    ...
    dapp: [
      {
        command: 'cactus_getWalletBalances',
        title: () => i18n._(/* i18n */ { id: 'Get Wallet Balances' }),
        message: () =>
          i18n._(
            /* i18n */ {
  ...
  'cactus_wallet.get_coin_records_by_names': {
    ...
    dapp: [
      {
        command: 'cactus_getCoinRecordsByNames',
        title: () => i18n._(/* i18n */ { id: 'Get Coin Records by Name' }),
        message: () =>
          i18n._(/* i18n */ { id: "Requests the status of a list of coin records from the Wallet's coin store." }),
  ...
  'cactus_wallet.get_spendable_coins': {
    ...
    dapp: [
      {
        command: 'cactus_getSpendableCoins',
        title: () => i18n._(/* i18n */ { id: 'Get Spendable Coins' }),
        message: () => i18n._(/* i18n */ { id: 'Requests spendable coins for a specific wallet' }),
        requiresSync: true,
        defaults: { wallet_id: 1 },
  ...
  'cactus_wallet.verify_signature': {
    ...
    dapp: [
      {
        command: 'cactus_verifySignature',
        title: () => i18n._(/* i18n */ { id: 'Verify Signature' }),
        message: () => i18n._(/* i18n */ { id: 'Requests the verification status for a digital signature' }),
        allowConfirmationBypass: true,
      },
  ...
  'cactus_wallet.get_next_address': {
    ...
    dapp: [
      ...
      {
        command: 'cactus_getCurrentAddress',
  ...
  'cactus_wallet.get_puzzle_and_solution': {
    ...
    dapp: [
      {
        command: 'cactus_getPuzzleAndSolution',
        title: () => i18n._(/* i18n */ { id: 'Get puzzle and solution' }),
        message: () =>
  ...
  'cactus_wallet.check_offer_validity': {
    ...
    dapp: [
      {
        command: 'cactus_checkOfferValidity',
        title: () => i18n._(/* i18n */ { id: 'Check Offer Validity' }),
        message: () => i18n._(/* i18n */ { id: 'Requests the validity status of a specific offer' }),
        allowConfirmationBypass: true,
      },
  ...
  'cactus_wallet.get_offer_summary': {
    ...
    dapp: [
      {
        command: 'cactus_getOfferSummary',
        title: () => i18n._(/* i18n */ { id: 'Get Offer Summary' }),
        message: () => i18n._(/* i18n */ { id: 'Requests the summarized details of a specific offer' }),
        allowConfirmationBypass: true,
      },
  ...
  'cactus_wallet.get_offer_record': {
  ...
  'cactus_wallet.cat_asset_id_to_name': {
    ...
    dapp: [
      {
        command: 'cactus_getCATWalletInfo',
        title: () => i18n._(/* i18n */ { id: 'Get CAT Wallet Info' }),
        allowConfirmationBypass: true,
      },
    ],
  ...
  'cactus_wallet.nft_get_wallets_with_dids': {
    ...
    dapp: [
      {
        command: 'cactus_getNFTWalletsWithDIDs',
        title: () => i18n._(/* i18n */ { id: 'Get NFT Wallets with DIDs' }),
  ...
  'cactus_wallet.did_get_current_coin_info': {
    ...
    dapp: [
      {
        command: 'cactus_getDIDCurrentCoinInfo',
        title: () => i18n._(/* i18n */ { id: 'Get DID Current Coin Info' }),
        allowConfirmationBypass: true,
      },
    ],
  ...
  'cactus_wallet.vc_get_proofs_for_root': {
    ...
    dapp: [
      {
        command: 'cactus_getProofsForRoot',
        title: () => i18n._(/* i18n */ { id: 'Get Proofs For Root Hash' }),
        allowConfirmationBypass: true,
      },
    ],
  ...
  'cactus_data_layer.get_sync_status': {
    ...
    dapp: [
      {
        command: 'cactus_getDataLayerSyncStatus',
        title: () => i18n._(/* i18n */ { id: 'Get DataLayer Sync Status' }),
        allowConfirmationBypass: true,
      },
    ],
  ...
  'daemon.get_wallet_addresses': {
    ...
    dapp: [
      {
        command: 'cactus_getWalletAddresses',
        title: () => i18n._(/* i18n */ { id: 'Get wallet addresses for one or more wallet keys' }),
