import { useGetLoggedInFingerprintQuery, useGetKeyQuery, useFingerprintSettings } from '@cactus-network/api-react';
import { Exit as ExitIcon } from '@cactus-network/icons';
